...
import ru.sbrf.lesson3.hw3and4.zoo.animal.interfaces.Swimmable;
...
public class Bear extends Animal implements Walkable, Swimmable, Dangerous {
    ...
    public void attack() {
        ...
        if (outcome < dangerousness) {
            ...
            throw new VisitorHurtException("Visitor came to close! Bear attacked and caused severe injuries!");
        }
        else {
