...
public class Tests {
    ...
    public void testEnclosure() {
        System.out.println("Testing enclosures: ");
        ...
        try {
            ...
            System.err.println("Enclosure " + enclosure2.getEnclosureID() + " is already full!");
        }

        System.out.println("AnimalDuplicateException:\n");
        ...
        try {
            ...
            System.err.println("Error trying to add the same animal twice!");
        }
    }
